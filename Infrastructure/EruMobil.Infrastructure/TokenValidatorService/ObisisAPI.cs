...
namespace EruMobil.Infrastructure.TokenValidatorService
{
    public class ObisisAPI:IObisisAPI
    {
        ...
        public ObisisAPI(HttpClient httpClient, IConfiguration configuration)
        {
            this.httpClient = httpClient;
            apiUrl = configuration["ObisisApiUrl"];
        }

        public async Task<bool> IsStudentTokenValid(string accessToken)
        {
            try
            {
